	<div class="testimonial--notice testimonial--notice__okay"><?php _e("Thank you for submitting your testimonial. It can take some time before it is visible.", TROPICAL_TESTIMONIALS_TEXT_DOMAIN) ?></div>
	<div class="testimonial" dir="ltr" lang="nl-NL" role="form" style="max-width:400px;">
		...
		<form class="testimonial-form" enctype="multipart/form-data" id="testimonial_form" method="post" name="testimonial_form" novalidate="novalidate">
			...
			<button disabled class="wpcf7-form-control wpcf7-submit" name="testimonial" type="submit"><?php _e('Add testimonial', TROPICAL_TESTIMONIALS_TEXT_DOMAIN) ?></button>
		</form>
	</div>